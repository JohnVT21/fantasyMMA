...
// Fetch fighters from the Fighters table
$fighters = [];
$sqlFighters = "SELECT FighterID, FullName, NickName, Wins, Losses, NoContests, WeightClass, AvgStrikes, AvgTakedowns 
                FROM Fighters";
...
<head>
    ...
    <title><?php echo htmlspecialchars($leagueName); ?> - Fighters</title>
    <style>
        body {
...
<body>
    <div class="league-home-container">
        <h1><?php echo htmlspecialchars($leagueName); ?> - Fighters</h1>
        <div class="nav-tabs">
        ...
        <?php elseif (empty($fighters)): ?>
            <p class="no-fighters">No fighters available.</p>
        <?php else: ?>
            <?php foreach ($fighters as $fighter): ?>
                <div class="fighter">
                    <h3><a href="individual_fighters.php?leagueid=<?php echo htmlspecialchars($leagueID); ?>&fighterid=<?php echo htmlspecialchars($fighter['FighterID']); ?>"><?php echo htmlspecialchars($fighter['FullName']); ?> "<?php echo htmlspecialchars($fighter['NickName'] ?? ''); ?>"</h3>
